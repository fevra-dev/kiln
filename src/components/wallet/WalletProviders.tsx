  ...
  const endpoint = useMemo(() => {
    ...
    if (configuredRpc) {
      ...
      if (configuredRpc.includes('helius') && configuredRpc.includes('api-key')) {
        console.log(
          '🔑 Using configured Helius RPC. If you see 401 errors, update NEXT_PUBLIC_SOLANA_RPC in .env.local',
        );
      }
    ...
    if (network === WalletAdapterNetwork.Mainnet) {
      ...
      console.warn(
        '⚠️ Using public mainnet RPC. Set NEXT_PUBLIC_SOLANA_RPC for better performance.',
      );
